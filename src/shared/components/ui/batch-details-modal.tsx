...
export function BatchDetailsModal({ 
  ...
  const mortalityRate = calculateMortalityRate(batch.totalMortality, batch.initialChickCount)
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`${batch.breed} - Batch Details`} size="xl">
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="font-bold">{batch.currentBirdCount.toLocaleString('en-IN')}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="font-bold text-red-600">{mortalityRate}%</p>
                </div>
              </div>
            </CardContent>
          </Card>

...
import { dailyRecordSchema, type DailyRecordFormData } from '@/shared/schemas/validation'
...
export function AddDailyRecordForm({ batchId, onSubmit, onCancel, isLoading }: AddDailyRecordFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          />
          {errors.feedBags && <p className="text-red-500 text-sm mt-1">{errors.feedBags.message}</p>}
        </div>
        ...
        <div>
          ...
          />
          {errors.feedCost && <p className="text-red-500 text-sm mt-1">{errors.feedCost.message}</p>}
        </div>
      </div>
      ...
      <div>
        ...
        />
        {errors.mortality && <p className="text-red-500 text-sm mt-1">{errors.mortality.message}</p>}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          />
          {errors.medicineUsed && <p className="text-red-500 text-sm mt-1">{errors.medicineUsed.message}</p>}
        </div>
        ...
        <div>
          ...
          />
          {errors.medicineCost && <p className="text-red-500 text-sm mt-1">{errors.medicineCost.message}</p>}
        </div>
      </div>

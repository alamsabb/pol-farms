...
export const batchSchema = z.object({
  ...
  initialChickCount: z.number().min(1, 'Initial chick count must be at least 1'),
  ...
  costPerChick: z.number().min(0.01, 'Cost per chick must be greater than 0'),
})
...
export const saleSchema = z.object({
  ...
  birdsSold: z.number().min(1, 'Birds sold must be at least 1'),
